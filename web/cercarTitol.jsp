        ...
        <form action="GestioLlibres?accio=cercarTitol" method="post">            
            ...
            <table cellspacing="2" cellpadding="2" border="0" align="center">
                <tr>
                    ...
                    <td><input type="Text" name="isbn_" size="30" value="<%=llibre == null ? "" : llibre.getIsbn()%>" readonly></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="Text" name="titol_" size="13" value="<%=llibre == null ? "" : llibre.getTitol()%>"></td>
